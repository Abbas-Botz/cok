...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝕾𝖎𝖑𝖆𝖍𝖐𝖆𝖓 𝕻𝖎𝖑𝖎𝖍 𝕯𝖎𝖘𝖓𝖎!","footerText": "Abbas Mods❤️","listType": "SINGLE_SELECT","sections": list}}, {})
       ...
       case 'othercmd':
               ...
               const yy = {title: 'Silahkan di pilih' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        footerText: 'case by Abbas Mods', imageMessage: imageMsg,
                        rowId: `${prefix}${x}`
                      }
                    ]
                   }
...
//------------------< by abbas chanel >-------------------  
case 'audio1':
man = fs.readFileSync('./abbas/audio1.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio2':
man = fs.readFileSync('./abbas/audio2.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio3':
man = fs.readFileSync('./abbas/audio3.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio4':
man = fs.readFileSync('./abbas/audio4.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio5':
man = fs.readFileSync('./abbas/audio5.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio6':
man = fs.readFileSync('./abbas/audio6.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
case 'audio7':
man = fs.readFileSync('./abbas/audio7.mp3');
dha.sendMessage(from, man, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
break
//------------------< bayar menu >-------------------  
case 'bayar':
...
*ID Guild :* -
*Minat Join? Chat* wa.me/68995820020
#WAVEFOREVER!`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©Abbas Botz* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://instagram.com/riski_abbas12?utm_medium=copy_link`)
             break
      case 'grupbot':
